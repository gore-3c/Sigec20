				...
				<div class="content-area">
					<div class="container">
						...
						<div class="page-header">
							<h4 class="page-title text-info"> Ajustements poids réels - Mise à Jour</h4>
                                    ...
                                    <div class="card-header">
                                        <div class="card-title">
                                        	<form method="post" action="/" class="form-inline">
										        ...
										        <div class="form-group">
										            <label for="Camp">Periode</label>
										            <select class="form-control" id="Per" name="Per"> </select>
										            <input type="button" id="btn" class="btn btn-primary" value="Charger" />
										            <span id="xLoad"></span>
										        </div>
										    </form>
                                        </div>
        ...
        <script>
            $(function() {
            	...
            	$('#Camp,#Prdt').change(function(){
            		ComboListe(0, $('#Camp').val(), $('#Prdt').val(), 'CboCamPdtPer', '#Per');            		
            	});
				$('#Per').change(function(){
            		AjustsMaJList($(this).val());
            	});
            	$('#btn').click(function(){
            		AjustsMaJ($('#Per').val());
            	});
