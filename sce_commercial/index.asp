...
<%		
	...
	'### - Création de la Commande à Exécuter
		Set Cmd_Db = Server.CreateObject("AdoDB.Command")
			...
			Cmd_Db.CommandText = "Ps_Doc_Index"
			Cmd_Db.CommandType = adCmdStoredProc

	'### - Définition des Paramètres de la Procédure Stockée SQL			
		Set Pm_Option	= Cmd_Db.CreateParameter("@Option", adVarChar, adParamInput, 25, "Saisie")	: Cmd_Db.Parameters.Append Pm_Option
	...
	'### - Exécution de la Commande SQL
		...
		Dim CvKKO, Fo1KKO, CvKFE, Fo1KFE, LbKFE, LbKKO, wColor
		Nb = 1 : tr = "" : xtr = "" : wtr = "" : ztr = ""
		CvKKO = 0 : Fo1KKO = 0 : CvKFE = 0 : Fo1KFE = 0
	...
	'### - Fermeture des Objets de Connexion
		...
		TxKFE = Round(Fo1KFE * 100 / (CvKFE+0.001),2)
		TxKKO = Round(Fo1KKO * 100 / (CvKKO+0.001),2)

		LbKFE = "danger" : LbKKO = "danger"
		If TxKFE > 50 Then LbKFE = "warning"
		If TxKFE > 70 Then LbKFE = "success"

		If TxKKO > 50 Then LbKKO = "warning"
		If TxKKO > 70 Then LbKKO = "success"

		If wtr = "" Then wtr = "<tr><th colspan=""4"" class=""text-center""> Aucune Suspension en cours</th></tr>"
