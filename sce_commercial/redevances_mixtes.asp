...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title> Paramétrage redevances differentiel mixte - SIGEC4</title>
	...
	<body class="app sidebar-mini rtl">
				...
				<div class="content-area">
					<div class="container">
						...
						<div class="page-header">
							<h4 class="page-title text-info"> Redevances diff mixte - Paramétrage</h4>
							...
							<div class="col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">Redevances - Paramétrage </div>
                                    </div>
                                    <div class="card-body">
											...
											<div class="tab-menu-heading">
												<div class="tabs-menu ">
													...
													<ul class="nav panel-tabs">
														<li class="">
															<a href="#tab1" data-toggle="tab">Liste des redevances</a>
														</li>
														<li><a href="#tab2" class="active" data-toggle="tab">Nouvelles redevances</a></li>
        ...
        <script  type="text/javaScript">
            ...
            $(function () {              
                ...
                FormulaireSaisieRedevancesMixtes('#wFrm');
                ComboListe(0, 0, 0, 'CboRecolte', '#Rclt', 'Récolte');

                $('#wFrm').on('change','#Prdt',function(){
...
*/
                ...
                $('#wFrm').on('click','#btn',function(){
					...
					if($('#Parite').val() == '0' || $('#Parite').val() == '') {
                        Msg = "Vous devez choisir la parité";
                        Err +=1;
					}
					if($('#TypeOp').val() == '0' || $('#TypeOp').val() == '') {
