	...
	<body class="app sidebar-mini rtl">
				...
				<div class="content-area">
					<div class="container">
						...
						<div class="page-header">
							<h4 class="page-title text-info">Redevances - Hors Normes</h4>
        ...
        <script  type="text/javaScript">
            ...
            $(function () {              
				...
				hn_redevance_liste('<%=(right(year(Now),2)+1)%>', $('#Produit').val(), $('#xParite').val(), '#wListe');
				_hn_redevances_new('#wFrm');
				$('#Recolte,#Produit,#xParite').change(function(){
                    hn_redevance_liste($('#Recolte').val(), $('#Produit').val(), $('#xParite').val(), '#wListe');
                });
                                

                $('#wFrm').on('change','#Prdt',function(){
                	$('#TabloRedevances').html(''); 
                	ComboFrmRedevancesHN($('#Prdt').val(), '#TabloRedevances');
                });
                ...
                $('#wListe').on('click','button',function(){
                	hn_affiche_redevances ($(this).attr('id'), '#tab3');
