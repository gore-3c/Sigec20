...
<html lang="en" dir="ltr">
	...
	<body class="app sidebar-mini rtl">
				...
				<div class="content-area">
					<div class="container">
						...
						<div class="page-header">
							<h4 class="page-title text-info"> Perceptions sur formules</h4>
							...
							<div class="col-md-*9 col-lg-9">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Traitement des formules</div>
									</div>
									<div class="card-body">
											...
											<div class="form-horizontal" role="form">
												<div class="form-group">
													<select name="rZone" id="rZone" class="form-control">
														...
														<option value="Ref_fo1">Reférence FO1</option>
														<option value="Num_Frc">Reférence</option>
													</select>
												</div>
												<div class="form-group">
        ...
        <script type="text/javascript" src="../assets/scripts/traitement_liste.js"></script>
        ...
        <script>
            $(function() {
				...
				formules_liste(0, $('#Zone').val(), $('#rZone').val(), '', '#xData');
				...
				$('#rbtn').click(function(){
					$('#wFrm').html('');$('#wEdit').html('');
					formules_liste(0, $('#Zone').val(), $('#rZone').val(), '', '#xData');					
				});
				
				$('#xData').on('click','a.wPrint', function(){
