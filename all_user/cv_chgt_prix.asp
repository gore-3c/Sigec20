...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>SIGEC4 - Correction de Prix CV AR</title>
	...
	<body class="app sidebar-mini rtl">
				...
				<div class="content-area">
					<div class="container">
						...
						<div class="page-header">
							<h4 class="page-title text-info"> CV Sans Soutien</h4>
							<ol class="breadcrumb"><!-- breadcrumb -->
								<li class="breadcrumb-item"><a href="#"> Paramétrage CV</a></li>
								<li class="breadcrumb-item active" aria-current="page">CV Sans Soutien</li>
							</ol><!-- End breadcrumb -->
						</div>
                        <!-- End page-header -->
							...
							<div class="col-md-9 col-lg-9">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"> CV Sans Soutien</div>
                                    </div>
                                    <div class="card-body">
        ...
        <script type="text/javascript" src="../assets/scripts/jquery.administrations.min.js"></script>
        ...
        <script>
            $(function() {
				...
				// - ### - Liste des formules
				$('#rbtn').click(function(){
					cv_sans_soutien($('#Cv').val(), '#xData');
					return false;
				});

				$('#xData').on('click','#btn',function(){
					swal({
	                    title: "CV Sans Soutien",
	                    text: 'Voulez-vous retirer le Soutien sur la CV ?',
	                    type: 'warning',
