    ...
    '### - Declaration des Variables 
        ...
        If Erreur = 0  then
            ...
            '### - Définition des Paramètres de la Procédure Stockée SQL
                ...
                Set Pm_Diff     = Cmd_Db.CreateParameter("@RevSou", adInteger, adParamInput, , Diff)      : Cmd_Db.Parameters.Append Pm_Diff
                Set Pm_Spec     = Cmd_Db.CreateParameter("@Special", adInteger, adParamInput, , Special)     : Cmd_Db.Parameters.Append Pm_Spec
                Set Pm_Tx       = Cmd_Db.CreateParameter("@TxCaut", adDouble, adParamInput, , TxCaut)     : Cmd_Db.Parameters.Append Pm_Tx
...
%>
    ...
    <form name="Frm" id="FrmDiff" class="form-horizontal" action="#" method="post">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="Diff" class="control-label"> Différentiel </label>                            
                            <select name="Diff" id="Diff" class="form-control">                                
                                <option value="0" selected> Mixte</option>
                            </select>
                        </div>
                    </div>                     
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="" class="control-label"> Redevance </label>                            
        ...
        <p class="text-center"> 
            ...
            <input type="hidden" id="Regime" name="Regime" value="1" />
            <input type="hidden" id="TypeDiff" name="TypeDiff" value="1" />
