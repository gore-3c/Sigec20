        ...
        If Erreur = 0  then
            ...
            '### - Création de la Commande à Exécuter
                Set Cmd_Db = Server.CreateObject("AdoDB.Command")
                    ...
                    Cmd_Db.CommandText = "Ps_Admin_CV_SANS_FS"
...
'################################
    ElseIf Choix_Enr = "2" Then ' Rechercher la CV à traiter
'################################
    ...
    '### - Définition des Paramètres de la Procédure Stockée SQL
        ...
        Do While Not (rs_Enr.EOF Or rs_Enr.BOF)
            ...
            tr = tr &"<tr>" & vbNewLine &_
                    ...
                    "</tr>" & vbNewLine &_
                    "<tr>" & vbNewLine &_
                    "    <td> Motif A/R : </td>" & vbNewLine &_
                    "    <td>" & rs_Enr("AR_REC") & "</td>" & vbNewLine &_
                    "    <td> <input type=""hidden"" name=""Cv_Id"" id=""Cv_Id"" value=""" & rs_Enr("CDC_ID") & """></td>" & vbNewLine &_   
                    "    <td><input type=""button"" id=""btn"" value=""Enregistrer"" class=""btn btn-success btn-sm"" /></td>" & vbNewLine &_                    
                    "</tr>"
            rs_Enr.MoveNext
        Loop
