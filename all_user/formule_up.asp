...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>SIGEC4 - CV de changement de parité</title>
	...
	<body class="app sidebar-mini rtl">
				...
				<div class="content-area">
					<div class="container">
						...
						<div class="page-header">
							<h4 class="page-title text-info"> CV changement de parité</h4>
							...
							<div class="col-md-9 col-lg-9">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"> CV de changement de parité</div>
                                    </div>
                                    <div class="card-body">
        ...
        <script>
            $(function() {
				...
				// - ### - Liste des formules
				$('#rbtn').click(function(){
					cv_chgt_parite($('#Cv').val(), '#xData');
					return false;
				});

				$('#xData').on('click','#btn',function(){
					swal({
	                    title: "Changement de Parité",
	                    text: 'Voulez-vous traiter cette CV ?',
	                    type: 'warning',
	                ...
	                function(){ //alert($('#Id').val() + ' - ' + $('#CDC').val());
	                    cv_chgt_parite_up($('#Id').val(), $('#CDC').val());
	                });
				});
